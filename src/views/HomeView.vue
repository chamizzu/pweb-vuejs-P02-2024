<template>
  <div>
    ...
    <div v-if="selectedBook">
      ...
      >
        <div
          class="bg-cyan-800 p-6 rounded shadow-lg text-center text-white h-5/6 overflow-y-auto"
          @click.stop
        >
          <img
            class="object-cover w-full rounded-t-lg mb-2"
